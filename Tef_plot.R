...
mtext("Species", side = c(2), at = c(length(unlist(plot.lists$habitat.plot.list)) +0.5), cex =0.5, line=12, font=2, las =1)
...
mtext("Diet", side = c(2), at = c(length(unlist(plot.lists$diet.plot.list)) +0.5), cex =0.5, line=8, font=2, las =1)
...
mtext("Tissue", side = c(2), at = c(length(unlist(plot.lists$tissue.plot.list)) +0.5), cex =0.5, line=5, font=2, las =1)
...
mtext("Habitat", side = c(2), at = c(length(unlist(plot.lists$habitat.plot.list)) +0.5), cex =0.5, line=1, font=2, las =1)
